# Amazon Linux 2023 Goss config

## Overview

based on CIS 1.0.0 - 6th June 2023
...
- [Audit Documents](https://github.com/ansible-lockdown/AMAZON2023-CIS-Audit/docs/Security_remediation_and_auditing.md)

This also works alongside the [Ansible Lockdown AMAZON2023-CIS role](https://github.com/ansible-lockdown/AMAZON2023-CIS)
